# Generated by Powerlevel10k configuration wizard on 2023-08-06 at 15:45 +07.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%00F'   # yellow foreground
      local   modified='%160F'  # yellow light foreground
      local  untracked='%000F'  # blue foreground
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=000
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=000
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=000
  ...
  typeset -g POWERLEVEL9K_NVM_BACKGROUND=77
  # If set to false, hide node version if it's the same as default:
  # $(nvm version current) == $(nvm version default).
  typeset -g POWERLEVEL9K_NVM_PROMPT_ALWAYS_SHOW=true
  # If set to false, hide node version if it's equal to "system".
  typeset -g POWERLEVEL9K_NVM_SHOW_SYSTEM=true
  typeset -g POWERLEVEL9K_NVM_PREFIX='%238F '
  # Custom icon.
